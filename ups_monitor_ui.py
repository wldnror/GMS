...
class UPSMonitorUI:
    ...
    def create_ups_box(self, index):
        ...
        # UPS 모드 표시
        mode_text_id = box_canvas.create_text(int(80 * SCALE_FACTOR), int(100 * SCALE_FACTOR), text="상시 모드", font=("Helvetica", int(16 * SCALE_FACTOR), "bold"), fill="#00FF00", anchor="center")
