...
class UPSMonitorUI:
    ...
    def create_ups_box(self, index):
        ...
        box_canvas = Canvas(inner_frame, width=int(155 * SCALE_FACTOR), height=int(3000 * SCALE_FACTOR), bg='grey', highlightthickness=0)
        box_canvas.pack()

        # 외곽 상자 디자인
        box_canvas.create_rectangle(0, 0, int(155 * SCALE_FACTOR), int(130 * SCALE_FACTOR), fill='grey', outline='grey', tags='border')
