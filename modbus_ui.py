...
class ModbusUI:
    ...
    def __init__(self, root, num_boxes, gas_types, alarm_callback):
        ...
        self.row_frames = []
        self.box_frames = []
        self.gradient_bar = create_gradient_bar(int(140 * SCALE_FACTOR), int(5 * SCALE_FACTOR))
    ...
    def create_modbus_box(self, index):
        ...
        circle_items.append(box_canvas.create_oval(int(133 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), int(200 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(123 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), int(190 * SCALE_FACTOR) - int(20 * SCALE_FACTOR)))
        box_canvas.create_text(int(95 * SCALE_FACTOR) - int(25 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), text="AL1", fill="#cccccc", anchor="e")

        circle_items.append(box_canvas.create_oval(int(77 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(200 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(87 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(190 * SCALE_FACTOR) - int(20 * SCALE_FACTOR)))
        box_canvas.create_text(int(140 * SCALE_FACTOR) - int(35 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), text="AL2", fill="#cccccc", anchor="e")
        ...
        box_canvas.create_text(int(35 * SCALE_FACTOR) - int(10 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), text="PWR", fill="#cccccc", anchor="center")

        circle_items.append(box_canvas.create_oval(int(171 * SCALE_FACTOR) - int(40 * SCALE_FACTOR), int(200 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(181 * SCALE_FACTOR) - int(40 * SCALE_FACTOR), int(190 * SCALE_FACTOR) - int(20 * SCALE_FACTOR)))
        box_canvas.create_text(int(175 * SCALE_FACTOR) - int(40 * SCALE_FACTOR), int(213 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), text="FUT", fill="#cccccc", anchor="n")
        ...
        bar_canvas = Canvas(box_canvas, width=int(140 * SCALE_FACTOR), height=int(5 * SCALE_FACTOR), bg="white", highlightthickness=0)
        bar_canvas.place(x=int(20 * SCALE_FACTOR), y=int(80 * SCALE_FACTOR))
