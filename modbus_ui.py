...
class ModbusUI:
    ...
    def create_modbus_box(self, index):
        ...
        circle_items.append(box_canvas.create_oval(int(171 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), int(200 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(181 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), int(190 * SCALE_FACTOR) - int(20 * SCALE_FACTOR)))
        box_canvas.create_text(int(175 * SCALE_FACTOR) - int(10 * SCALE_FACTOR), int(213 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), text="FUT", fill="#cccccc", anchor="n")
