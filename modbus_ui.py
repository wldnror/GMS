...
class ModbusUI:
    ...
    def create_modbus_box(self, index):
        ...
        box_canvas.create_text(int(95 * SCALE_FACTOR) - int(10 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), text="AL1", fill="#cccccc", anchor="e")
        ...
        box_canvas.create_text(int(35 * SCALE_FACTOR) - int(10 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), text="PWR", fill="#cccccc", anchor="center")
