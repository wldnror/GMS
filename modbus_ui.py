...
class ModbusUI:
    ...
    GAS_TYPE_POSITIONS = {
        "ORG": (int(110 * SCALE_FACTOR), int(102 * SCALE_FACTOR)),
        "ARF-T": (int(101 * SCALE_FACTOR), int(102 * SCALE_FACTOR)),
        "HMDS": (int(104 * SCALE_FACTOR), int(102 * SCALE_FACTOR)),
        "HC-100": (int(109 * SCALE_FACTOR), int(102 * SCALE_FACTOR))
    }
