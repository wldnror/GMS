...
class ModbusUI:
    ...
    def create_modbus_box(self, index):
        ...
        box_canvas.create_text(int(95 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), text="AL1", fill="#cccccc", anchor="e")
        ...
        box_canvas.create_text(int(140 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), text="AL2", fill="#cccccc", anchor="e")
