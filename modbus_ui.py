...
class ModbusUI:
    ...
    def create_modbus_box(self, index):
        ...
        circle_items.append(box_canvas.create_oval(int(133 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(200 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(123 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(190 * SCALE_FACTOR) - int(20 * SCALE_FACTOR)))
        ...
        box_canvas.create_text(int(140 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(30 * SCALE_FACTOR), text="AL2", fill="#cccccc", anchor="e")

        circle_items.append(box_canvas.create_oval(int(30 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(200 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(40 * SCALE_FACTOR) - int(10 * SCALE_FACTOR), int(190 * SCALE_FACTOR) - int(20 * SCALE_FACTOR)))
