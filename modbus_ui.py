...
class ModbusUI:
    ...
    def create_modbus_box(self, index):
        ...
        box_canvas.create_text(int(95 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), text="AL1", fill="#cccccc", anchor="e")
        ...
        circle_items.append(box_canvas.create_oval(int(30 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(200 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(40 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), int(190 * SCALE_FACTOR) - int(20 * SCALE_FACTOR)))
        box_canvas.create_text(int(35 * SCALE_FACTOR), int(220 * SCALE_FACTOR) - int(20 * SCALE_FACTOR), text="PWR", fill="#cccccc", anchor="center")
