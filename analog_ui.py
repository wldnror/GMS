...
class AnalogUI:
    ...
    def animate_value(self, box_index, target_value, duration=0.5):
        ...
        def update_animation():
            ...
            if t < 1:
                self.root.after(50, update_animation)  # 50ms 간격으로 애니메이션 업데이트
    ...
    async def read_adc_data(self):
        ...
        while True:
            ...
            await asyncio.sleep(0.1)  # 샘플링 속도
