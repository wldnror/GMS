...
class AnalogUI:
    ...
    def create_analog_box(self, index):
        ...
        led1 = box_canvas.create_rectangle(0, int(205 * SCALE_FACTOR), int(78 * SCALE_FACTOR), int(220 * SCALE_FACTOR), fill='#FF0000', outline='white')
        led2 = box_canvas.create_rectangle(int(78 * SCALE_FACTOR), int(205 * SCALE_FACTOR), int(155 * SCALE_FACTOR), int(220 * SCALE_FACTOR), fill='#FF0000', outline='white')
