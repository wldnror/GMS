...
if __name__ == "__main__":
    ...
    if 0 <= total_boxes <= 4:
        clock_label = tk.Label(root, font=("Helvetica", 60, "bold"), fg="white", bg="black", anchor='center', padx=10, pady=0)
        clock_label.place(relx=0.5, rely=0.1, anchor='n')

        date_label = tk.Label(root, font=("Helvetica", 29), fg="white", bg="black", anchor='center', padx=5, pady=0)
