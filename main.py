...
if __name__ == "__main__":
    ...
    if 0 <= total_boxes <= 4:
        clock_label = tk.Label(root, font=("Helvetica", 60, "bold"), fg="white", bg="black", height=0.1, anchor='center', padx=10, pady=10)
        clock_label.place(relx=0.5, rely=0.1, anchor='n')

        date_label = tk.Label(root, font=("Helvetica", 29), fg="white", bg="black",height=1, anchor='center', padx=5, pady=5)
        date_label.place(relx=0.5, rely=0.18, anchor='n')
